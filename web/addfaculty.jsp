<%-- 
    Document   : addfaculty
    Created on : Apr 1, 2019, 1:09:26 AM
...
<html>
    <head>
        ...
        <title>Add Faculty Account</title>
    ...
    <body>
          <div class="div2">
        <div class="div1">
            <h2 class="titl">Adding Account</h2>
            <hr>
            <form name ="signupform" action="AddFaculty" method="post" onsubmit="return myValidation()">
            <h3 id="ma">Email: </h3>
            ...
            <input type="password" placeholder="enter password here" name="password" id="ma"><br>
            ...
            <br><button type="submit" id="subm">Add Account</button>
            </form>
