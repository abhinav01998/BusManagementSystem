...
<html>
    ...
    <body>
        ...
        <div class="main">
           ...
           <a href="ShowStudData" class="active">Time Table</a>
            <a href="adminsearch.jsp">Search</a>
            <a href="adminprofile.jsp">Profile</a>
            <a href="Students">Students List</a>
            <a href="Faculty">Faculty List</a>
             <h3><span style="float:right;margin-left: 610px;font-size: 17px;margin-top: 4px;">User:  <span style="color: blue;"><%=
                session.getAttribute("username").toString()
                %></span></span></h3>
            </div>           
                 <div style="display: flex;margin-left: 150px;margin-top: 100px;">
                 <form action="AddBusDataAdmin">
    ...
    out.println("<a  href='DropBusDataAdmin?busnodrop="+disp.getBusno()+"'>Remove</a>");
